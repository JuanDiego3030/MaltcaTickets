...
# CRUD para Ticket
def crear_ticket(tipo_soporte_id, comentario, usuario_id, area_id, atendido_por_id):
...
def actualizar_ticket(ticket_id, **kwargs):
    Ticket.objects.filter(id=ticket_id).update(**kwargs)
